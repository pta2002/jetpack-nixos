...
with ps;
let
  edk2-pytool-library = buildPythonPackage rec {
  ...
  edk2-pytool-extensions = buildPythonPackage rec {
  ...
  edk2-basetools = buildPythonPackage rec {
  ...
  kconfiglib = buildPythonPackage rec {
    pname = "kconfiglib";
